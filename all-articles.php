...
$stmt = $pdo->query("SELECT a.id, a.title, a.published_at, c.name AS category_name FROM articles a JOIN categories c ON a.category_id = c.id ORDER BY published_at DESC");
...
<body>
<header>All Articles - Admin</header>
<nav>
